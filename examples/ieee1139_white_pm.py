...
# L
plt.figure()
plt.semilogx(f_fi, [10*math.log(ff)/math.log(10) for ff in psd_fi] ,label='numpy.fft()')
plt.semilogx(f_fi2, [10*math.log(ff)/math.log(10) for ff in psd_fi2],label='scipy.signal.welch()')
plt.semilogx(f_fi, [10*math.log( h2*v0*v0)/math.log(10)]*len(f_fi) ,label='h2 * v0^2'  )
plt.legend(framealpha=0.5)
